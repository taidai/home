...
import re
from daitest.log import logger
from daitest.globals import g, now, timestamp
from daitest.elements import e
from daitest.windows import w
from daitest.snapshot import Snapshot
from daitest.locator import locating_elements, locating_data, locating_element
from daitest.keywords import web, common, mobile, http, files
from daitest.config import web_keywords, common_keywords, mobile_keywords, http_keywords, windows_keywords, files_keywords
from daitest.utility import replace_dict, replace
        ...
        for index, step in enumerate(self.testcase['steps']):
            ...
            try:
                ...
                if g.platform.lower() in ('desktop',) and step['keyword'].upper() in web_keywords:
                    ...
                    from daitest.keywords import windows
                    _page = ''
