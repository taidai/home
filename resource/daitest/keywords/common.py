...
from daitest.parse import data_format
from daitest.database import DB
from daitest.utility import replace_dict, compare
from injson import check
from daitest.utility import json2dict
...
def execute(step):
    ...
    from daitest.testcase import TestCase
